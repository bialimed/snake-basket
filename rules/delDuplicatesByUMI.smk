...
def delDuplicatesByUMI(
    ...
    if params_umi_separator:
        in_group_aln = params_tmp_folder + "/tagUMI/tmp_" + out_filename
        setUMITagFromID(
    ...
    groupReadsByUMI(
        ...
        out_alignments=params_tmp_folder + "/group/tmp_" + out_filename,
        out_stderr=out_stderr,
        params_stderr_append=True,
    ...
    callMolecularConsensus(
        in_alignments=params_tmp_folder + "/group/tmp_" + out_filename,
        out_alignments=params_tmp_folder + "/consensus/tmp_" + out_filename,
        out_stderr=out_stderr,
        params_stderr_append=True,
    ...
    filterUMIConsensus(
        in_alignments=params_tmp_folder + "/consensus/tmp_" + out_filename,
        in_reference_seq=in_reference_seq,
        out_alignments=params_tmp_folder + "/filter/tmp_" + out_filename,
        out_stderr=out_stderr,
        params_stderr_append=True,
    ...
    samToFastq(
        in_alignments=params_tmp_folder + "/filter/tmp_" + out_filename,
        out_R1=params_tmp_folder + "/raw/tmp_" + out_filename + "_R1.fastq.gz",
        out_R2=params_tmp_folder + "/raw/tmp_" + out_filename + "_R2.fastq.gz",
        out_stderr=out_stderr,
        params_stderr_append=True,
    ...
    params_aln_fct(
        in_reads=[
            params_tmp_folder + "/raw/tmp_" + out_filename + "_R1.fastq.gz",
            params_tmp_folder + "/raw/tmp_" + out_filename + "_R2.fastq.gz"
        ],
        in_reference_seq=in_reference_seq,
